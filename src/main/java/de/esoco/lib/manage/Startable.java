 ...
 * complementary interfaces {@link de.esoco.lib.manage.Stoppable} and/or
 * {@link de.esoco.lib.manage.RunCheck} to provide a way to stop execution and
 * check for the end of execution, respectively.
 *
 * @author eso
 */
