...
public abstract class InterceptionAdvice implements Cloneable
{
	 ...
	 * always invoke {@link InterceptionAdvice#invoke(Interception, Object,
	 * Method, Object, Object[]) super.invoke()} to support the chaining of
	 * advice.</p>
	 *
	 ...
	 *
	 * <p>If a subclass chooses to override this method it should at least
	 * always invoke the method {@link #invoke(Interception, Object, Method,
	 * Object, Object[]) invoke()} to support the chaining of advice that may
	 * have been setup by the InterceptionProxy class.</p>
	 *
	 * @param  rInterception The interception to be advised.
	 * @param  rProxy        The proxy on which the method has been invoked
	 * @param  rMethod       The original method that has been invoked
	 ...
	 * interception returned normally of after it threw an exception. It will be
	 * invoked by the default implementations of {@link #afterReturn(Object,
	 * Object, Method, Object[]) afterReturn()} and {@link
	 * #afterThrow(Throwable, Object, Method, Object[]) afterThrow()}.
	 *
	 ...
	 * exectuted successfully (i.e., without throwing an exception). The default
	 * implementation just invokes {@link #after(Object, Method, Object[])
	 * after()} which by default does nothing.
	 *
	...
	/***************************************
	 * This method can be implemented to perform actions after an interception
	 * threw an exception. The default implementation just invokes {@link
	 * #after(Object, Method, Object[]) after()} which by default does nothing.
	 *
	 ...
	 * object. This method is invoked by the InterceptionProxy to chain multiple
	 * advice together.
	 *
