...
/********************************************************************
 * Implements a range of long values that can be iterated through.
 *
 * @author eso
 */
public class LongRange extends NumberRange<Long>
{
	 ...
	 */
	LongRange(long nFirst, long nLast, long nStep)
	{
	 ...
	 */
	@Override
	protected Long getNextValue(Long rCurrent, long nStep)
	{
		return rCurrent.longValue() + nStep;
	}
}
